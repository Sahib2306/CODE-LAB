...
public class ListArray {
    public static void main(String[] args) {
        ...
        // ob.remove(0);
        // ob.remove("Data 4");System.out.println(ob);
        ArrayList<String> StringObject=new ArrayList<>();
        ArrayList<Integer> IntegerObject= new ArrayList<>();
            ...
            if(userInput==4){
                ...
                if(userMovie==1){
                    ...
                    if(userTicket<ticket){
                        ticket-=userTicket;
                        StringObject.add("Movie booked is Param Sundri");
                        IntegerObject.add(userTicket);
